...
const ChatCamera = () => {
	...
	return (
		<>
			<div className='aspect-[9/10] flex flex-col items-center justify-center h-[35%] bg-black rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-sigColorBgBorder mx-auto lg:mx-0'>
				<div
				...
				<p className='w-2/3 text-center text-white mt-4 font-semibold'>Нажмите на камеру, чтобы отправить свой мем.</p>
			</div>
			{step === 0 ? (
				<ImagePreviewDialog
