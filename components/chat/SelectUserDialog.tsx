...
const SelectUserDialog = ({ selectedFile, onClose, onPrev }: SelectUserDialogProps) => {
	const handleSendMessage = () => console.log("Сообщение отправлено");
		...
		<Dialog open={!!selectedFile}>
			...
			>
				<DialogHeader>
					...
					<p className='font-semibold py-2'>Чаты:</p>
				...
				<DialogFooter className='mx-auto flex items-center'>
					...
					>
						Отправить <TextMessageSent className='text-white scale-95 my-auto' />
					</Button>
				</DialogFooter>
			</DialogContent>
		</Dialog>
